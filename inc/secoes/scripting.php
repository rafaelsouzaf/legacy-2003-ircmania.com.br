<?
	$sql = "select count(sid) as vl from artigos where chk='1' and topic='11'"; 
	$qry = mysql_query($sql); 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
    <strong><font size="2"><u>Script(ing)</u></font></strong></td>
  </tr>
</table>
...
<?
$where = "where (topic='11' or nivel='1') and chk='1'";
