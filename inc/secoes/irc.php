<?
	$sql = "select count(sid) as vl from artigos where chk='1' and topic='3'";
	$qry = mysql_query($sql);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
    <strong><font size="2"><u>Artigos IRC & Chat</u></font></strong></td>
  </tr>
</table>
...
<?
$where = "where (topic='3' or nivel='5') and chk='1'";
