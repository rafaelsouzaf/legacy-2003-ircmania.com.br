<?
	$sql = "select count(sid) as vl from artigos where chk='1' and topic='14'"; 
	$qry = mysql_query($sql); 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
    <strong><font size="2"><u>Bots, Eggdrop & TCL</u></font></strong></td>
  </tr>
</table>
...
<?
$where = "where (topic='14' or nivel='3') and chk='1'";
