<?
	$sql = "select count(sid) as vl from artigos where chk='1' and topic='12'"; 
	$qry = mysql_query($sql); 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
    <strong><font size="2"><u>Entrevistas</u></font></strong></td>
  </tr>
</table>

<br><br>

<p align="center"><a href="outros.php?enviartexto=ok"><u>Sugira uma entrevista. Entre em contato.</u></a>
...
<?
$where = "where topic='12' and chk='1' and nivel='0'";
